...
/* matrix_vector_product_omp: Compute matrix-vector product c[m] = a[m][n] * b[n] in OoepnMP */
void matrix_vector_product_omp(double *a, double *b, double *c, int m, int n)
{
    #pragma omp parallel
    {
        ...
        t = omp_get_wtime() - t;
        printf("Thread %d/%d rows %d [%10d - %10d]: %.6f sec.\n", threadid, nthreads, ub - lb + 1, lb, ub, t);
    }
}
